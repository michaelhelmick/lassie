...
class LassieTwitterCardTestCase(LassieBaseTestCase):
    def test_twitter_all_properties(self):
        ...
        self.assertEqual(data['description'],
                         'Buy Now! http://smarturl.it/CallMeMaybe Music video by Carly '
                         'Rae Jepsen performing Call Me Maybe. (C) 2011 604 Records '
                         'Inc. #VEVOCertified on June 8, 2012. h...')

        self.assertEqual(len(data['images']), 1)
        image = data['images'][0]
        self.assertEqual(image['src'],
                         'http://i1.ytimg.com/vi/fWNaR-rxAic/maxresdefault.jpg')
    ...
    def test_twitter_no_og_title_use_twitter_title(self):
        ...
        self.assertEqual(data['title'],
                         'Lassie Twitter Test | no_og_title_use_twitter_title')
